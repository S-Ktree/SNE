...
\addlegendentry{\scriptsize $\mathrm{T}=0.1$};
}%
...
\only<6>{\addlegendentry{\scriptsize $\mathrm{T}=0.5$};}
%
%\addplot [
%color=blue,
%solid, thick
...
%10 0\\
%};
%%\addlegendentry{\scriptsize $\mathrm{T}=1/|\lambda|$};
%
%\addplot [
%color=red,
%solid
...
%10 -1\\
%};
%%\addlegendentry{\scriptsize $\mathrm{T}=2/|\lambda|$};
\only<8->{
\addplot [
color=mycolor2,
solid, very thick
...
%%\addlegendentry{\scriptsize $\mathrm{T}=2.1/|\lambda|$};
