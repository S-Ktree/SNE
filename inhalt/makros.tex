...
%%% Ein rechter brace der die nodes 2 und 3 umschließt.
...
%% Befehl, um einfach Beschriftungen mit Pfeil hinzuzufügen: (hält Abstand nach unten/oben automatisch ein! (standardmäßig in footnotesize aber durch voranstellen einer größe überschreibbar!)
...
% 2.: Länge des Inhalts /Markierung
%3. : Inhalt
{
\ifLeiter
...
% Markierung für Übungsleiter, einzeilig!
